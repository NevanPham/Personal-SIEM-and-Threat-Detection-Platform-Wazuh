...
2. Select the agent ID (001)
3. Confirm removal
4. Press Q to quit

Restart the manager for clean state:
...
**note**: 
 - CLI is preferred for learning and scripting
 - but i will mostly use dashboard to learn first to get used to all the features of wazuh.
